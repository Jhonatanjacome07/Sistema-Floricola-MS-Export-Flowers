...
@section('content_header')
    <h1 class="text-center"> <b>Editar Ingreso</b></h1>
@stop
...
@section('content')
    ...
    <section>
        ...
        <form method="POST" action="{{ route('flowers.update', $flowers) }}" class="mx-auto" style="max-width: 900px;">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-adminlte-input type="text" name="name" label="Nombre" label-class="text-lightblue"
                                placeholder="Nombre de la variedad" value="{{ $flowers->name }}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <x-adminlte-input type="text" name="nbloque" label="Número de bloque" label-class="text-lightblue"
                                placeholder="Ingrese el número de bloque" value="{{ $flowers->nbloque }}">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
                                        <i class="fas fa-seedling text-lightblue"></i>
                                    </div>
