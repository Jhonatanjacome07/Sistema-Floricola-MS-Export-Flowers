...
@section('content')
   ...
   <form method="POST" action="{{ route('recepcion.store') }}" class="mx-auto" style="max-width: 900px;">
    @csrf
    <div class="card text-white bg-amber" style="border-radius: 20px;">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <x-adminlte-input type="text" name="cantidadtallos" label="Número tallos" label-class="text-lightblue" value="{{ old('cantidadtallos') }}">
                        <x-slot name="prependSlot">
                            <div class="input-group-text">
                                <i class="fas fa-seedling text-lightblue"></i>
                            </div>
            ...
            <div class="text-center">
                ...
                <x-adminlte-button label="Cancelar" theme="danger" icon="fas fa-ban" onclick="location.href='{{ route('recepcion.index') }}'" />
            </div>
